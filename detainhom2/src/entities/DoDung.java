...
public class DoDung {
	...
	public DoDung(String maSP, TheLoai theLoai, String tenSP, String tenNSB, NhaCungCap tenNCC, String donVT,
	...
	public String toString() {
		return "DoDung [maSP=" + maSP + ", theLoai=" + theLoai + ", tenSP=" + tenSP + ", tenNSB=" + tenNSB + ", tenNCC="
				+ tenNCC + ", donVT=" + donVT + ", giaNhap=" + giaNhap + ", donGia=" + donGia + ", soLuong=" + soLuong
