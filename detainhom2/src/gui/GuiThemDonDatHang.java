...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		JLabel lblNewLabel = new JLabel("Thêm Đơn Đặt Hàng");
		...
		btnlaphd = new JButton("Thêm Đơn Đặt Hàng");
		btnlaphd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(txtmaKH.getText().equals(""))
				{
					JOptionPane.showMessageDialog(btnlaphd, "Vui lòng thêm thông tin khách hàng để lập đơn đặt hàng");
				}
				else
				{
					JOptionPane.showMessageDialog(btnlaphd, "Đơn đặt hàng đã được thêm mới!");
